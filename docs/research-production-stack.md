...
[nginx `map` and regex config](../infra/nginx/nginx.conf#L89-L109),
[nginx upstream locations](../infra/nginx/nginx.conf#L124-L165).
...
[nginx forwarded headers](../infra/nginx/nginx.conf#L124-L133),
...
[generated nginx config](../infra/nginx/nginx.conf#L124-L165).
